...
import {
  ...
  TODOIST_INTEGRATION_SECTION_ID
...
> = {
  ...
  todoist: {
    get label() {
      return translate('auto.components.settings.TasksPane.todoist', 'Todoist')
    },
    get description() {
      return translate(
        'auto.components.settings.TasksPane.todoistDescription',
        'Connect Todoist with a personal API token and show it in Tasks.'
      )
    },
              ...
              >
                {provider === 'linear' ? (
                  ...
                  <TodoistSetupSteps
                    ...
                    onConnected={() => void checkTodoistConnection()}
                    onOpenIntegrations={() => openIntegrations(TODOIST_INTEGRATION_SECTION_ID)}
                  />
                ) : (
                  <CodeHostSetupSteps
