...
export type GlobalSettings = {
  ...
  /** Why: one-shot guard to make Todoist visible for existing profiles once, without re-adding after a later opt-out. */
  visibleTaskProvidersDefaultedForTodoist: boolean
